...
template <typename T>
using Matrix3 = blaze::StaticMatrix<T, 3, 3, blaze::rowMajor, blaze::aligned, blaze::padded>;

using Matrix3f = blaze::StaticMatrix<float_t, 3, 3, blaze::rowMajor, blaze::aligned, blaze::padded>;

using Matrix3d =
    blaze::StaticMatrix<double_t, 3, 3, blaze::rowMajor, blaze::aligned, blaze::padded>;
