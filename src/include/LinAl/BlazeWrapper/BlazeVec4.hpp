...
using Vec4f = blaze::StaticVector<float_t, 4, blaze::columnVector, blaze::aligned, blaze::padded>;
using Vec4d = blaze::StaticVector<double_t, 4, blaze::columnVector, blaze::aligned, blaze::padded>;
